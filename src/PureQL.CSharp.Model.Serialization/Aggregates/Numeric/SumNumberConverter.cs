...
internal sealed class SumNumberConverter : JsonConverter<SumNumber>
{
    public override SumNumber Read(
    ...
    )
    {
        ...
        return aggregate.Operator != NumericAggregateOperatorJsonModel.sum
            ? throw new JsonException()
            : new SumNumber(aggregate.Arg);
    }
