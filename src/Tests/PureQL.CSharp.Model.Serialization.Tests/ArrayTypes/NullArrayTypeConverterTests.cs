...
public sealed record NullArrayTypeConverterTests
{
    private readonly JsonSerializerOptions _options;

    public NullArrayTypeConverterTests()
    {
    ...
    public void Read()
    {
        ...
        NullArrayType type = JsonSerializer.Deserialize<NullArrayType>(input, _options)!;

        Assert.Equal(type.Name, new NullArrayType().Name);
    }
