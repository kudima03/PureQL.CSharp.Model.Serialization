...
public sealed record DivideConverterTests
{
    private readonly JsonSerializerOptions _options;

    public DivideConverterTests()
    {
    ...
    public void ThrowsExceptionOnOperatorNameAbsence()
    {
        ...
        _ = Assert.Throws<JsonException>(() =>
            JsonSerializer.Deserialize<Divide>(input, _options)
        );
    }
    ...
    public void WriteEmptyArguments()
    {
        ...
        string value = JsonSerializer.Serialize(new Divide([]), _options);
    ...
    public void ReadScalarArguments()
    {
        ...
        Assert.Equal(
            ...
            JsonSerializer.Deserialize<Divide>(input, _options)!.Arguments
        );
    }
