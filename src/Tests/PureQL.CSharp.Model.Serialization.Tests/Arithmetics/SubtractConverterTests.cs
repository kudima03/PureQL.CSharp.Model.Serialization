...
public sealed record SubtractConverterTests
{
    private readonly JsonSerializerOptions _options;

    public SubtractConverterTests()
    {
    ...
    public void ThrowsExceptionOnOperatorNameAbsence()
    {
        ...
        _ = Assert.Throws<JsonException>(() =>
            JsonSerializer.Deserialize<Subtract>(input, _options)
        );
    }
    ...
    public void WriteEmptyArguments()
    {
        ...
        string value = JsonSerializer.Serialize(new Subtract([]), _options);
