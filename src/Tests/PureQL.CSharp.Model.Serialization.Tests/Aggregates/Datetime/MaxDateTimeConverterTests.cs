...
public sealed record MaxDateTimeConverterTests
{
    ...
    public void ReadScalarArgument()
    {
        ...
        Assert.Equal(expected, JsonSerializer.Deserialize<MaxDateTime>(input, _options)!.Argument.AsT2.Value);
    }
    ...
    public void ReadParameterArgument()
    {
        ...
        Assert.Equal(new DateTimeArrayParameter(expectedParamName), JsonSerializer.Deserialize<MaxDateTime>(input, _options)!.Argument.AsT0);
    }
    ...
    public void ReadFieldArgument()
    {
        ...
        Assert.Equal(new DateTimeField(expectedEntityName, expectedFieldName), JsonSerializer.Deserialize<MaxDateTime>(input, _options)!.Argument.AsT1);
    }
