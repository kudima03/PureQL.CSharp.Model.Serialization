...
public sealed record MaxDateConverterTests
{
    private readonly JsonSerializerOptions _options;

    public MaxDateConverterTests()
    {
    ...
    public void ThrowsExceptionOnOperatorNameAbsence()
    {
        ...
        _ = Assert.Throws<JsonException>(() =>
            JsonSerializer.Deserialize<MaxDate>(input, _options)
        );
    }
    ...
    public void ReadScalarArgument()
    {
        ...
        Assert.Equal(
            expectedDates,
            JsonSerializer.Deserialize<MaxDate>(input, _options)!.Argument.AsT2.Value
        );
    }
    ...
    public void ReadParameterArgument()
    {
        ...
        Assert.Equal(
            ...
            JsonSerializer.Deserialize<MaxDate>(input, _options)!.Argument.AsT0
        );
    }
    ...
    public void ReadFieldArgument()
    {
        ...
        Assert.Equal(
            ...
            JsonSerializer.Deserialize<MaxDate>(input, _options)!.Argument.AsT1
        );
    }
