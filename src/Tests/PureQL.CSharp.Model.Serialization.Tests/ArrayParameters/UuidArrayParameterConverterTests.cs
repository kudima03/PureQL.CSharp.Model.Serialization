...
public sealed record UuidArrayParameterConverterTests
{
    private readonly JsonSerializerOptions _options;

    public UuidArrayParameterConverterTests()
    {
    ...
    public void ReadName()
    {
        ...
        UuidArrayParameter parameter = JsonSerializer.Deserialize<UuidArrayParameter>(
            input,
            _options
        )!;
    ...
    public void Write()
    {
        ...
        string output = JsonSerializer.Serialize(
            new UuidArrayParameter("auiheyrdsnf"),
            _options
        );
